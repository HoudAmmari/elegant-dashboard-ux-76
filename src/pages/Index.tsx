...
export default function Index() {
  return (
    <div className="space-y-4 md:space-y-5 pb-6">
      {/* Activity Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 md:mb-5">
        <h2 className="text-xl font-semibold mb-2 sm:mb-0">Activity</h2>
        <div className="flex items-center space-x-2 bg-white rounded-lg p-2 card-shadow self-start">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5 mt-3 md:mt-5">
        <SalesChart />
        <TopProducts />
      </div>
